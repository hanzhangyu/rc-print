    ...
    function Print(props) {
        ...
        _this.writeTemplate = function (doc) {
            var _this$props2 = _this.props,
                ...
                isIframe = _this$props2.isIframe;

            var bodyAttrs = isIframe ? '' : 'onload="window.print()" '; // window时在body上植入事件
            if (lazyRender) {
                ...
                doc.write('<html>\n                <head>' + _this.getHead() + '</head>\n                <body ' + bodyAttrs + '>' + dom + (bodyStyle ? '<style>' + _this.getBodyStyle() + '</style>' : '') + '</body>\n            </html>');
            }
            doc.close();
        };
        ...
        _this.renderChild = function () {
            ...
            return (0, _react.cloneElement)(_react2['default'].Children.only(children));
        };
        ...
        _this.onPrint = function () {
            var _this$props3 = _this.props,
                ...
                clearIframeCache = _this$props3.clearIframeCache,
                singletonCache = _this$props3.singletonCache,
